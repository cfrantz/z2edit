#ifndef Z2UTIL_UTIL_IMGUI_IMPL_SDL_H
#define Z2UTIL_UTIL_IMGUI_IMPL_SDL_H
...
IMGUI_API void ImGui_ImplSdl_SetHiDPIScale(float scale);
IMGUI_API float ImGui_ImplSdl_GetHiDPIScale();

#endif // Z2UTIL_UTIL_IMGUI_IMPL_SDL_H
